...
private:
    ...
    float _last_ey = 0;
    float _last_ew = 0;
    float _grab_comp_ex = 0;
    float _grab_comp_ey = 0;
    float _f_tx = 200;
    float _f_ty = 0;
    float _grab_x = 200;
    float _grab_y = 0;
    ...
    GrabState _currentState = G_STATE_INIT;
    ...
    unsigned long _last_bbox_time = 0;
    unsigned long _last_i2c_time = 0;
    bool _has_valid_bbox = false;
    int _stableCount = 0;
...
extern AprilTagGrabber aprilTagGrabber;
