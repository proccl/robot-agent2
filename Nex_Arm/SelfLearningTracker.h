#ifndef SELF_LEARNING_TRACKER_H
#define SELF_LEARNING_TRACKER_H
...
public:
    ...
    void begin();
    void start();
    void confirm(String targetID, int x, int y);
    void stop();
    void update();
...
extern SelfLearningTracker selfLearningTracker;
